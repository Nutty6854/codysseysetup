...
![localhost:8080 포트 매핑 접속 성공](images/docker_practice.png)

스크린샷에서 브라우저 주소창의 `localhost:8080`과 직접 작성한 NGINX 웹페이지가 한 화면에 표시되는 것을 확인했습니다. 이를 통해 호스트의 8080번 포트에서 컨테이너 웹 서버에 정상적으로 접속했음을 증명했습니다.
